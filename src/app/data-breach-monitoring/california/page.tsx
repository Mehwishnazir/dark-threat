...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/data-breach-monitoring/california" },
};
...
const breadcrumb = breadcrumbSchema([
  ...
  { name: 'Locations', url: 'https://darkthreat.ai/data-leak-detection' },
      ...
      <section className="relative min-h-[62vh] flex flex-col items-center justify-center overflow-hidden pt-12 pb-16 hero-bg-layered">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-6">
          <div className="mb-4 inline-flex justify-center">
            <Breadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/data-leak-detection' }, { label: 'California' }]} />
          </div>
