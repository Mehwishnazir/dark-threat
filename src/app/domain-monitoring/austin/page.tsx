...
export const metadata: Metadata = {
  ...
  description: "Protect your Austin organization with advanced Domain Monitoring. Detect and remediate threats before they become data breaches. Book a demo today.",
  alternates: { canonical: "/domain-monitoring/austin" },
};
      ...
      <section className="relative min-h-[62vh] flex flex-col items-center justify-center overflow-hidden pt-12 pb-16 hero-bg-layered">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-6">
          <div className="mb-4 inline-flex justify-center">
            <Breadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/dark-web-monitoring' }, { label: 'Austin' }]} />
          </div>
