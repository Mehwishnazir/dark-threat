          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4 text-foreground/90 leading-relaxed">
                ...
                <div className="space-y-3 ml-4">
                  <div>
                    <strong>Dark Web Monitoring</strong> – Tracks corporate domains and sub-domains across paste sites, forums, and online marketplaces. This helps organizations quickly identify if sensitive information or company assets are being shared without authorization.
                  </div>
                  <div>
                    <strong>Credential Leak Alerts</strong> – Monitors employee and VIP email accounts and passwords for leaks. Users are notified immediately if their credentials appear in compromised databases, helping prevent unauthorized access to systems and data.
                  </div>
                  <div>
                    <strong>Hacker Chatter Tracking</strong> – Scans forums, chatrooms, and private channels for mentions of the organization. This provides early alerts about potential threats, attack planning, or other malicious activity targeting the company.
                  </div>
                </div>
                <p>
            ...
            <section>
              ...
              <div className="space-y-4 text-foreground/90 leading-relaxed">
                ...
                <p>
                  All intelligence collected from dark web sources is handled with strict confidentiality. This ensures ethical monitoring and prevents sensitive information from being misused. Users are encouraged to review the <Link href="/privacy-policy" className="text-primary hover:underline">Privacy Policy</Link>, which explains in detail how data is collected, stored, processed, and protected.
                </p>
                <p>
            ...
            <section>
              ...
              <div className="space-y-4 text-foreground/90 leading-relaxed">
                ...
                <p>
                  Users can reach out via email at: <a href="mailto:support@darkthreat.ai" className="text-primary hover:text-primary/80">support@darkthreat.ai</a>
                </p>
              </div>
            </section>
          </div>
