    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <nav className="flex flex-wrap gap-x-4 gap-y-2 text-sm text-muted-foreground mb-8" aria-label="Related legal documents">
          ...
          <Link href="/website-terms" className="hover:text-primary">Website Terms of Use</Link>
        </nav>
        ...
        <div className="space-y-8">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-montserrat font-semibold text-foreground text-primary mb-4">Information We Collect</h2>
              <p className="text-foreground/90 leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Personal Information:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Usage Data:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Dark Web Monitoring Data:</h3>
                  <p className="text-foreground/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-montserrat font-semibold text-foreground text-primary mb-4">How We Use Your Information</h2>
              <p className="text-foreground/90 leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Provide Services:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Improve Platform Features:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Communication and Support:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Legal and Regulatory Compliance:</h3>
                  <p className="text-foreground/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-montserrat font-semibold text-foreground text-primary mb-4">Sharing of Information</h2>
              <p className="text-foreground/90 leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">With Service Providers:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Legal Requirements:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Business Transfers:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Aggregated/Non-identifiable Data:</h3>
                  <p className="text-foreground/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-montserrat font-semibold text-foreground text-primary mb-4">Data Retention</h2>
              <p className="text-foreground/90 leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Storage Duration:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Compliance Retention Periods:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Deletion and Archiving:</h3>
                  <p className="text-foreground/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-montserrat font-semibold text-foreground text-primary mb-4">Security of Your Data</h2>
              <p className="text-foreground/90 leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Protection Measures:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Access Controls:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Incident Response:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Ongoing Improvements:</h3>
                  <p className="text-foreground/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-montserrat font-semibold text-foreground text-primary mb-4">User Rights</h2>
              <p className="text-foreground/90 leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Access, Correction, and Deletion:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Opt-Out of Marketing Communications:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Data Portability Requests:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Exercising Your Rights:</h3>
                  <p className="text-foreground/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-montserrat font-semibold text-foreground text-primary mb-4">Cookies and Tracking</h2>
              <p className="text-foreground/90 leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Types of Cookies:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Managing Cookies:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Tracking Technologies:</h3>
                  <p className="text-foreground/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-montserrat font-semibold text-foreground text-primary mb-4">Third-Party Services</h2>
              <p className="text-foreground/90 leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Third-Party Integrations:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground mb-2">Handling of Data:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Accountability:</h3>
                  <p className="text-foreground/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-montserrat font-semibold text-foreground text-primary mb-4">International Data Transfers</h2>
              <p className="text-foreground/90 leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Cross-Border Data Handling:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Regulatory Compliance:</h3>
                  <p className="text-foreground/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-montserrat font-semibold text-foreground text-primary mb-4">Changes to This Privacy Policy</h2>
              <p className="text-foreground/90 leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Policy Updates:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Effective Date:</h3>
                  <p className="text-foreground/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-montserrat font-semibold text-foreground text-primary mb-4">Contact Information</h2>
              <p className="text-foreground/90 leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Privacy Officer / Support Team:</h3>
                  <p className="text-foreground/90 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-montserrat font-medium text-foreground text-primary mb-2">Feedback and Inquiries:</h3>
                  <p className="text-foreground/90 leading-relaxed">
