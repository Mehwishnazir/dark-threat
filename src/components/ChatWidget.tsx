...
const SUPABASE_ANON_KEY =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhndXpnZ2djZG5lcnljY2NpaG92Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTYxMTQxODksImV4cCI6MjA3MTY5MDE4OX0.hcBRIiYV8LLkMnh1SQM9y4IrjZkCkHZ5KgTDlLeV1PM";
...
function saveSession(messages: Msg[]) {
  try {
    sessionStorage.setItem(STORAGE_KEY, JSON.stringify({ messages, updated: Date.now() }));
  } catch {
    /* ignore quota */
  }
}
    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          <form onSubmit={send} className="border-t border-border p-2 bg-card flex items-end gap-2">
            <textarea
              ref={inputRef}
              value={input}
