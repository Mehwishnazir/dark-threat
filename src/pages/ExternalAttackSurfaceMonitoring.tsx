...
const ExternalAttackSurfaceMonitoring = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await submitLeadForm({
        formType: 'Free Assessment (External Attack Surface Monitoring)',
        name: formData.name,
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>External Attack Surface Monitoring | DarkThreat</title>
        <meta
          name="description"
          content="Track internet-facing digital footprint, shadow IT assets, open ports, cloud exposures, and third-party supply chain vulnerabilities."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://darkthreat.ai/external-attack-surface-monitoring" />

        <meta property="og:type" content="website" />
        <meta property="og:title" content="External Attack Surface Monitoring | DarkThreat" />
        <meta property="og:description" content="Track internet-facing digital footprint, shadow IT assets, open ports, cloud exposures, and third-party supply chain vulnerabilities." />
        <meta property="og:url" content="https://darkthreat.ai/external-attack-surface-monitoring" />
        ...
        <meta name="twitter:title" content="External Attack Surface Monitoring | DarkThreat" />
        <meta name="twitter:description" content="Track internet-facing digital footprint, shadow IT assets, open ports, cloud exposures, and third-party supply chain vulnerabilities." />
...
export default ExternalAttackSurfaceMonitoring;
