...
export default function IndustriesPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Industry Dark Web Monitoring | DarkThreat</title>
        <meta name="description" content="DarkThreat delivers sector-specific dark web monitoring for financial services, healthcare, legal, government, e-commerce, SaaS, education, and crypto industries." />
        <link rel="canonical" href="https://darkthreat.ai/industries" />
      ...
      {/* SECTION 1: Hero */}
      <section className="relative min-h-[60vh] flex flex-col items-center justify-center overflow-hidden pt-32 pb-16 hero-bg-layered">
