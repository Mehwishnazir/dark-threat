...
const ManagedSocSupport = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await submitLeadForm({
        formType: 'Free Assessment (24/7 Managed SOC Support)',
        name: formData.name,
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>24/7 Managed SOC Support | DarkThreat</title>
        <meta
          name="description"
          content="Expert-led Security Operations Center validation that reduces alert fatigue by cross-verifying threat relevance before alerting your team."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://darkthreat.ai/managed-soc-support" />

        <meta property="og:type" content="website" />
        <meta property="og:title" content="24/7 Managed SOC Support | DarkThreat" />
        <meta property="og:description" content="Expert-led Security Operations Center validation that reduces alert fatigue by cross-verifying threat relevance before alerting your team." />
        <meta property="og:url" content="https://darkthreat.ai/managed-soc-support" />
        ...
        <meta name="twitter:title" content="24/7 Managed SOC Support | DarkThreat" />
        <meta name="twitter:description" content="Expert-led Security Operations Center validation that reduces alert fatigue by cross-verifying threat relevance before alerting your team." />
...
export default ManagedSocSupport;
