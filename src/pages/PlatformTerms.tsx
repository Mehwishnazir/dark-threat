      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8">
          ...
          <div className="prose prose-invert max-w-none space-y-6">
            <section>
              <h2 className="text-2xl font-oswald font-semibold text-foreground text-primary mb-4">Service Description</h2>
            ...
            <section>
              <h2 className="text-2xl font-oswald font-semibold text-foreground text-primary mb-4">Acceptable Use</h2>
            ...
            <section>
              <h2 className="text-2xl font-oswald font-semibold text-foreground text-primary mb-4">Service Availability</h2>
              <p className="text-foreground/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-oswald font-semibold text-foreground text-primary mb-4">Data and Privacy</h2>
              <p className="text-foreground/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-oswald font-semibold text-foreground text-primary mb-4">Limitation of Liability</h2>
              <p className="text-foreground/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-oswald font-semibold text-foreground text-primary mb-4">Termination</h2>
              <p className="text-foreground/90 leading-relaxed">
