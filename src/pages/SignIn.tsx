        ...
        <Card className="bg-card/90 backdrop-blur-xl border-border shadow-2xl">
          <div className="p-8 space-y-6">
            ...
            <div className="text-center">
              ...
              <h1 className="text-2xl font-oswald font-bold text-foreground">DarkThreat</h1>
              <p className="text-muted-foreground text-sm">Access your threat intelligence dashboard</p>
            </div>
