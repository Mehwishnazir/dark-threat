...
export default function ExecutiveMonitoringBoston() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await submitLeadForm({ formType: 'Location Inquiry (Executive Monitoring - Boston)', name: form.name, email: form.email, company: form.company, message: form.message });
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Executive Monitoring in Boston | Enterprise Cybersecurity by DarkThreat</title>
        <meta name="description" content="Protect your Boston organization with advanced Executive Monitoring. Detect and remediate threats before they become data breaches. Book a demo today." />
        <link rel="canonical" href="https://darkthreat.ai/executive-monitoring/boston" />
