...
export default function ThreatIntelligenceWashingtonDC() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await submitLeadForm({ formType: 'Location Inquiry (Threat Intelligence - Washington DC)', name: form.name, email: form.email, company: form.company, message: form.message });
